...
fund:
	@forge script script/Interactions.s.sol:FundInteract --sender $(SENDER_ADDRESS) $(NETWORK_ARGS)

withdraw:
	@forge script script/Interactions.s.sol:WithdrawInteract --sender $(SENDER_ADDRESS) $(NETWORK_ARGS)